...
namespace SchoolRegister.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<SchoolRegister.ViewModels.JwtIssuerOptions>(options => Configuration.GetSection("JwtIssuerOptions").Bind(options)); // get a Jwt options from appsettings.json
            services.AddOptions();
